...
import cn.eight.employservice.service.impl.XfglServiceImp;
 ...
 */
@WebServlet(urlPatterns = "/houtai/xfglSvl",name = "XfglServlet",initParams = {@WebInitParam(name = "pageSize",value = "10")})
