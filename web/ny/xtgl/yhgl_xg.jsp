...
<br/>
<br>
<form action="${pageContext.request.contextPath}/accountSvl?reqType=modaccount&available=${sessionScope.status}&searchValue=${sessionScope.name}&pageNow=${requestScope.pageNow}&number=${requestScope.number}" method="post">
<table width="96%" height="97" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3"
    ...
    <tr>
        ...
        <td width="296" bgcolor="#FFFFFF">
            <input name="textarea" readonly type="text" id="textarea" value="${account.accountname}" size="30" class="pi">
