        ...
        <tr>
            <td width="67%" align="right" class="text" nowrap>&nbsp;姓名：
                ...
                <input type="button" name="addbtn2" value="新  增" class="button_new"
                       onClick="javascript:location.href='ny/rlzy/grxx_xz.jsp'">
                &nbsp;&nbsp;
            </td>
        </tr>
    </table>
...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    ...
    <c:forEach items="${staffList}" var="staff">
        <tr align="center" class="td2" onmouseover="javascript:changeBgColorOnMouseOver(this);"
            onMouseOut="javascript:changeBgColorOnMouseOut(this);" onDblClick="doDBClick('staffsvl?reqType=querystaffinformation&wid=${staff.wid}&ck=ck',true,'2');">
            ...
            <td align="center" nowrap>
                ...
                <a href="staffsvl?reqType=querystaffinformation&wid=${staff.wid}&xg=xg&pageNow=${pageNow}&page=grxxall">修改</a></td>
        </tr>
    </c:forEach>
</table>
