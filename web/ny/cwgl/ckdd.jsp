...
女</td>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><input name="textarea24" type="text" id="textarea24" value="${deal.intro_price}" size="20" class="pi"></td>
    </tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input type="radio" name="radioEdu" id="radioEdu1" value="${work.status}" />
        大专&nbsp;
	...
	<tr>
      ...
      <td colspan="7" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox4" id="checkbox1" value="${deal.employ_type}" />
        月嫂
&nbsp;
...
<input name="textarea9" type="text" id="textarea1" value="${work.skill},${work.self}" size="40" class="pi"></td>
    ...
    <tr>
      ...
      <td align="left" bgcolor="#FFFFFF"><input name="textarea21" type="text" id="textarea21" value="${deal.price}" size="14" class="pi"></td>
      <td align="right" bgcolor="#FFFFFF">订单有效期:</td>
      <td align="left" bgcolor="#FFFFFF"><input name="textarea27" type="text" id="textarea27" value="${deal.dealtime}" size="14" class="pi"></td>
      <td align="right" bgcolor="#FFFFFF">状态：</td>
      <td align="left" bgcolor="#FFFFFF"><span class="text">
        <select name="select" id="select" class="input">
          <option>${deal.statue}</option>
