...
<table width="96%" height="512" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3"
    ...
    <c:forEach items="${staffinformationList}" var="staffinformation">
        ...
        <tr>
            ...
            <td bgcolor="#FFFFFF">
                <input name="textarea2" type="text" id="textarea2" value="${staffinformation.wname}" size="30" class="pi"></td>
        ...
        <tr>
            ...
            <td bgcolor="#FFFFFF">
                <input name="textarea11" type="text" id="textarea11" value="${staffinformation.idcard}" size="30" class="pi">
            </td>
            <td height="23" align="right" bgcolor="#FFFFFF">出生年月：</td>
            <td bgcolor="#FFFFFF">
                <input name="textarea3" type="text" id="textarea3" value="${staffinformation.birth}" size="30" class="pi"></td>
        </tr>
        <tr>
            <td align="right" bgcolor="#FFFFFF">年龄：</td>
            <td bgcolor="#FFFFFF">
                <input name="textarea5" type="text" id="textarea5" value="${staffinformation.wage}" size="30" class="pi"></td>
            <td height="23" align="right" bgcolor="#FFFFFF">身高：</td>
            <td bgcolor="#FFFFFF">
                <input name="textarea8" type="text" id="textarea8" value="${staffinformation.hige}" size="30" class="pi"></td>
        </tr>
        <tr>
            <td align="right" bgcolor="#FFFFFF">手机：</td>
            <td bgcolor="#FFFFFF"><input name="textarea6" type="text" id="textarea6" value="${staffinformation.cellphone}" size="30" class="pi"></td>
            <td align="right" bgcolor="#FFFFFF">电话：</td>
            <td bgcolor="#FFFFFF"><input name="textarea6" type="text" id="textarea6" value="${staffinformation.phone}" size="30" class="pi"></td>
        </tr>
        <tr>
            <td align="right" bgcolor="#FFFFFF">工种：</td>
            <td bgcolor="#FFFFFF"><input name="textarea6" type="text" id="textarea6" value="${staffinformation.type}" size="30" class="pi"></td>
            <td align="right" bgcolor="#FFFFFF">从业时间：</td>
            <td bgcolor="#FFFFFF"><input name="textarea7" type="text" id="textarea7" value="${staffinformation.worktime}" size="30" class="pi"></td>
        </tr>
        <tr>
            <td height="23" align="right" bgcolor="#FFFFFF">缺陷：</td>
            <td bgcolor="#FFFFFF"><input name="textarea10" type="text" id="textarea10" value="${staffinformation.defect}" size="30" class="pi">
            </td>
        ...
        <tr>
            ...
            <td colspan="4" bgcolor="#FFFFFF">
                <input name="textarea12" type="text" id="textarea12" value="${staffinformation.jhddress}" size="65" class="pi">
            </td>
        </tr>
        <tr>
            <td height="23" align="right" bgcolor="#FFFFFF">现住地址：</td>
            <td colspan="4" bgcolor="#FFFFFF">
                <input name="textarea13" type="text" id="textarea13" value="${staffinformation.address}" size="65" class="pi">
            </td>
        </tr>
        <tr>
            <td height="23" align="right" bgcolor="#FFFFFF">银行卡号：</td>
            <td bgcolor="#FFFFFF"><input name="textarea14" type="text" id="textarea14" value="${staffinformation.card}" size="30" class="pi">
            </td>
            <td align="right" bgcolor="#FFFFFF">保险单号：</td>
            <td bgcolor="#FFFFFF"><input name="textarea15" type="text" id="textarea15" value="${staffinformation.bxnumber}" size="30" class="pi">
            </td>
        ...
        <tr>
            ...
            <td colspan="4" bgcolor="#FFFFFF">
                <input type="radio" name="rad" id="radio4" value="radio"/>
                在岗&nbsp;&nbsp;
                <input type="radio" name="rad" id="radio5" value="radio"/>
                待岗&nbsp;&nbsp;
                <input type="radio" name="rad" id="radio6" value="radio"/>
                其它：&nbsp;
        ...
        <tr>
            ...
            <td colspan="4" bgcolor="#FFFFFF">
                <input type="radio" name="ra" id="radio7" value="radio"/>
                已婚
                &nbsp;
                <input type="radio" name="ra" id="radio8" value="radio"/>
                未婚&nbsp;&nbsp;
                <input type="radio" name="ra" id="radio9" value="radio"/>
                离异
                &nbsp;
                <input type="radio" name="ra" id="radio10" value="radio"/>
                丧偶
                &nbsp;&nbsp;
                <input type="radio" name="ra" id="radio11" value="radio"/>
                其它：&nbsp;
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
                    <tr>
                        ...
                        <td width="21%" bgcolor="#FFFFFF">
                            <input name="textarea20" type="text" id="textarea20" value="" size="16" class="pi"></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="4" bgcolor="#FFFFFF">
                <textarea name="textarea35" id="textarea35" cols="60" rows="5"></textarea>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="4" bgcolor="#FFFFFF">
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
                    ...
                    <tr>
                        ...
                        <td height="28" bgcolor="#FFFFFF">
                            <input name="textarea37" type="text" id="textarea37" value=""
                                   size="40" class="pi"></td>
                        <td height="28" align="right" bgcolor="#FFFFFF">餐饮或其它：</td>
                        <td height="28" bgcolor="#FFFFFF">
                            <input name="textarea38" type="text" id="textarea38" value=""
                                   size="40" class="pi"></td>
                    </tr>
                </table>
            </td>
        ...
        <script>
            ...
            } else if (${staffinformation.language=="广东话"}) {
